...
var todayItems = [
    TodayModel(
        ...
        subtitle: "CREATIVE",
        image: "1",
        shortDescription: "Minecraft is a video game in which players create and break apart various kinds of blocks in three-dimensional worlds.",
