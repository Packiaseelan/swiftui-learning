...
struct SearchNavigationView<Content: View>: UIViewControllerRepresentable {
    ...
    init( placeHolder: String? = "Search", largeTitle: Bool? = true, title: String, onSearch: @escaping (String) -> (), onCancel: @escaping () -> (), onFocusChange: @escaping (Bool) -> (),@ViewBuilder view: () -> Content) {
